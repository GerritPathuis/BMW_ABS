...
}if(!CQ_Analytics.GigyaProfile){CQ_Analytics.GigyaProfile=function(){};
CQ_Analytics.GigyaProfile.prototype=new CQ_Analytics.PersistedSessionStore();
CQ_Analytics.GigyaProfile.prototype.STOREKEY="GIGYAPROFILEDATA";
CQ_Analytics.GigyaProfile.prototype.STORENAME="gigyaprofile";
CQ_Analytics.GigyaProfile.prototype.getLabel=function(a){return a
};
CQ_Analytics.GigyaProfile.prototype.getLink=function(a){return""
};
CQ_Analytics.GigyaProfile.prototype.clear=function(){if(this.persistence){this.persistence.remove(this.getStoreKey())
}this.data=null;
this.initProperty={}
};
CQ_Analytics.GigyaProfile.prototype.init=function(){this.persistence=new CQ_Analytics.SessionPersistence({container:"ClientContext"});
var a=this.persistence.get(this.getStoreKey());
if(!a||a==""){this.data={};
for(var b in this.initProperty){this.data[b]=this.initProperty[b]
}}else{this.data=this.parse(a)
...
CQ_Analytics.GigyaProfile.prototype.getLoaderURL=function(){return"/bin/gigya/personalization/components/load.json/profile"
};
CQ_Analytics.GigyaProfile.prototype.loadProfile=function(authorizableId){if(authorizableId){this.setProperty("authorizableId",authorizableId);
var url=this.getLoaderURL();
url=CQ_Analytics.Utils.addParameter(url,"authorizableId",authorizableId);
CQ_Analytics.GigyaProfile.lastUid=authorizableId;
try{var object=CQ.shared.HTTP.eval(url);
if(object){this.data={};
for(var p in object){this.data[p]=object[p]
...
CQ_Analytics.GigyaProfile=new CQ_Analytics.GigyaProfile();
...
if(a!=this.getProperty("authorizableId")){CQ_Analytics.GigyaProfile.loadProfile(a);
this.fireEvent("update")
}},CQ_Analytics.GigyaProfile)
});
CQ_Analytics.CCM.register(CQ_Analytics.GigyaProfile)
}if(!CQ_Analytics.GigyaLikes){CQ_Analytics.GigyaLikes=function(){};
CQ_Analytics.GigyaLikes.prototype=new CQ_Analytics.PersistedSessionStore();
CQ_Analytics.GigyaLikes.prototype.STOREKEY="GIGYALIKESDATA";
CQ_Analytics.GigyaLikes.prototype.STORENAME="gigyalikes";
CQ_Analytics.GigyaLikes.prototype.getLabel=function(a){return a
};
CQ_Analytics.GigyaLikes.prototype.getLink=function(a){return""
};
CQ_Analytics.GigyaLikes.prototype.clear=function(){if(this.persistence){this.persistence.remove(this.getStoreKey())
}this.data=null;
this.initProperty={}
};
CQ_Analytics.GigyaLikes.prototype.init=function(){this.persistence=new CQ_Analytics.SessionPersistence({container:"ClientContext"});
var a=this.persistence.get(this.getStoreKey());
if(!a||a==""){this.data={};
for(var b in this.initProperty){this.data[b]=this.initProperty[b]
}}else{this.data=this.parse(a)
...
CQ_Analytics.GigyaLikes.prototype.getLoaderURL=function(){return"/bin/gigya/personalization/components/load.json/likes"
};
CQ_Analytics.GigyaLikes.prototype.loadProfile=function(authorizableId){if(authorizableId){this.setProperty("authorizableId",authorizableId);
var url=this.getLoaderURL();
url=CQ_Analytics.Utils.addParameter(url,"authorizableId",authorizableId);
CQ_Analytics.GigyaLikes.lastUid=authorizableId;
try{var object=CQ.shared.HTTP.eval(url);
if(object){this.data={};
for(var p in object){this.data[p]=object[p]
}this.setProperty("authorizableId",authorizableId);
...
CQ_Analytics.GigyaLikes=new CQ_Analytics.GigyaLikes();
CQ_Analytics.ClientContextUtils.onStoreRegistered("profile",function(){CQ_Analytics.ProfileDataMgr.addListener("update",function(){var a=CQ_Analytics.ProfileDataMgr.getProperty("authorizableId");
if(a!=this.getProperty("authorizableId")){CQ_Analytics.GigyaLikes.loadProfile(a);
this.fireEvent("update")
}},CQ_Analytics.GigyaLikes)
});
CQ_Analytics.CCM.register(CQ_Analytics.GigyaLikes)
}if(!CQ_Analytics.GigyaFavorites){CQ_Analytics.GigyaFavorites=function(){};
CQ_Analytics.GigyaFavorites.prototype=new CQ_Analytics.PersistedSessionStore();
CQ_Analytics.GigyaFavorites.prototype.STOREKEY="GIGYAFAVORITESDATA";
CQ_Analytics.GigyaFavorites.prototype.STORENAME="gigyafavorites";
CQ_Analytics.GigyaFavorites.prototype.getLabel=function(a){return a
};
CQ_Analytics.GigyaFavorites.prototype.getLink=function(a){return""
};
CQ_Analytics.GigyaFavorites.prototype.clear=function(){if(this.persistence){this.persistence.remove(this.getStoreKey())
}this.data=null;
this.initProperty={}
};
CQ_Analytics.GigyaFavorites.prototype.init=function(){this.persistence=new CQ_Analytics.SessionPersistence({container:"ClientContext"});
var a=this.persistence.get(this.getStoreKey());
if(!a||a==""){this.data={};
for(var b in this.initProperty){this.data[b]=this.initProperty[b]
}}else{this.data=this.parse(a)
...
CQ_Analytics.GigyaFavorites.prototype.getLoaderURL=function(){return"/bin/gigya/personalization/components/load.json/favorites"
};
CQ_Analytics.GigyaFavorites.prototype.loadProfile=function(authorizableId){if(authorizableId){this.setProperty("authorizableId",authorizableId);
var url=this.getLoaderURL();
url=CQ_Analytics.Utils.addParameter(url,"authorizableId",authorizableId);
CQ_Analytics.GigyaFavorites.lastUid=authorizableId;
try{var object=CQ.shared.HTTP.eval(url);
if(object){this.data={};
for(var p in object){this.data[p]=object[p]
}this.setProperty("authorizableId",authorizableId);
...
CQ_Analytics.GigyaFavorites=new CQ_Analytics.GigyaFavorites();
CQ_Analytics.ClientContextUtils.onStoreRegistered("profile",function(){CQ_Analytics.ProfileDataMgr.addListener("update",function(){var a=CQ_Analytics.ProfileDataMgr.getProperty("authorizableId");
if(a!=this.getProperty("authorizableId")){CQ_Analytics.GigyaFavorites.loadProfile(a);
this.fireEvent("update")
}},CQ_Analytics.GigyaFavorites)
});
CQ_Analytics.CCM.register(CQ_Analytics.GigyaFavorites)
};